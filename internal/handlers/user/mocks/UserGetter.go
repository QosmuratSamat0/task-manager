// Code moved from internal/handlers/redirect/mocks/UserGetter.go
...
// User provides a mock function with given fields: email
func (_m *UserGetter) User(email string) (model.User, error) {
	ret := _m.Called(email)
